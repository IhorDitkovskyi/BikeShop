		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					<li class="active"><a href="/admin/brand<custom:allParams/>">Brand</a></li>
...
<div class="row">
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/brand" method="POST" modelAttribute="brand" enctype="multipart/form-data">
					<custom:hiddenInputs excludeParams="brand, file"/>
					<div class="form-group">
						<label style="color:red;text-align:left;" for="name" class="col-sm-10 col-sm-offset-2 control-label"><form:errors path="brand"/></label>
					</div>
					<div class="form-group">
		...
		<div class="row">
			...
			<div class="col-md-3 col-xs-3"><h3>Brand name</h3></div>
			...
			<c:forEach items="${page.content}" var="brand">
				<div class="row">
					<div class="col-md-3 col-xs-3"><img src="/images/brand/${brand.id}.jpg?version=${brand.version}" width="120" height="120"></div>
					<div class="col-md-3 col-xs-3">${brand.brand}</div>
